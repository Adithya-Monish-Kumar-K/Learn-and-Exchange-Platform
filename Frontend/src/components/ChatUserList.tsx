...
interface ChatUserListState {
  searchTerm: string;
}

class ChatUserList extends React.PureComponent<
  ChatUserListProps,
  ChatUserListState
> {
  state: ChatUserListState = {
    searchTerm: '',
  };
  ...
  render() {
    const { users, selectedUserId, onNewRequest, onViewRequests } = this.props;
